...
public final class FormCommande {
	...
	public Commande creationCommande(HttpServletRequest request, String chemin) {
		...
		if (ANCIEN_CLIENT.equals(choixNouveauClient)) {
			 ...
			 * 
			 * L'objet métier pour valider la création d'un client existe déjà, il est donc
			 * déconseillé de dupliquer ici son contenu ! À la place, il suffit de passer la
			 ...
			 * d'erreur créée par l'objet métier CreationClientForm dans la map d'erreurs
